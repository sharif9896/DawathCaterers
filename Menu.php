...
<div class="go">
    ...
    <br>
    <div class="poi">
        <h1>Menu of The Dawath Caterers</h1>
    </div>
    <br>
    <div class="te">
        <p>Dawath Caterers</p>
    ...
    <div class="sps">
        <div class="holder">
            <div class="cards border">
                <div class="play">
                    <!-- <div style="display: flex; align-items: center; justify-content: center; width: 48px; height: 48px; background-color: #00FF00; border-radius: 50%;"> -->
                    <!-- <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        Play button path
                        <path d="M5 20V4L19 12L5 20Z" stroke="#000000" stroke-width="1.5" fill="#000"
                            stroke-linejoin="round" />
                    </svg> -->
                    </div>
                    <!-- </div> -->
                <img aria-hidden="false" draggable="false" loading="lazy"
                    src="ac.PNG" data-testid="card-image"
                    class="srk"
        ...
        <div class="cards border">
            ...
            <img aria-hidden="false" draggable="false" loading="lazy"
                    src="cfg.PNG" data-testid="card-image"
                    class="srk"
                    class="mMx2LUixlnN_Fu45JpFB SKJSok3LfyedjZjujmFt yOKoknIYYzAE90pe7_SE Yn2Ei5QZn19gria6LjZj">
        ...
        <div class="cards border">
            ...
            <img aria-hidden="false" draggable="false" loading="lazy"
                    src="dr.PNG" data-testid="card-image"
                    class="srk"
                    class="mMx2LUixlnN_Fu45JpFB SKJSok3LfyedjZjujmFt yOKoknIYYzAE90pe7_SE Yn2Ei5QZn19gria6LjZj">
        ...
        <div class="cards border">
            ...
            <img aria-hidden="false" draggable="false" loading="lazy"
                    src="sd.PNG" data-testid="card-image"
                    class="srk"
                    class="mMx2LUixlnN_Fu45JpFB SKJSok3LfyedjZjujmFt yOKoknIYYzAE90pe7_SE Yn2Ei5QZn19gria6LjZj">
        ...
        <div class="cards border">
            ...
            <img aria-hidden="false" draggable="false" loading="lazy"
                    src="qw.PNG" data-testid="card-image"
                    class="srk"
                    class="mMx2LUixlnN_Fu45JpFB SKJSok3LfyedjZjujmFt yOKoknIYYzAE90pe7_SE Yn2Ei5QZn19gria6LjZj">
        ...
        <div class="cards border">
            ...
            <img aria-hidden="false" draggable="false" loading="lazy"
                    src="aaz.PNG" data-testid="card-image"
                    class="srk"
                    class="mMx2LUixlnN_Fu45JpFB SKJSok3LfyedjZjujmFt yOKoknIYYzAE90pe7_SE Yn2Ei5QZn19gria6LjZj">
        ...
        <div class="cards border">
            ...
            <img aria-hidden="false" draggable="false" loading="lazy"
                    src="swq.PNG" data-testid="card-image"
                    class="srk"
                    class="mMx2LUixlnN_Fu45JpFB SKJSok3LfyedjZjujmFt yOKoknIYYzAE90pe7_SE Yn2Ei5QZn19gria6LjZj">
        ...
        <!-- <div class="slide">
            <img src="qwsaz.jpg" alt="Image 1"  class="moc">
        </div> -->
        <br>
        <br>
        <br>
